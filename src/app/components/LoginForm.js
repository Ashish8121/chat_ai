    ...
    <div className="animate-fade-in-up">
      <div className="card rounded-2xl p-8 max-w-md w-full mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              required
              className="form-input w-full px-4 py-4 rounded-xl focus-ring"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                required
                className="form-input w-full px-4 py-4 rounded-xl focus-ring pr-12"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="btn-primary w-full py-4 px-6 rounded-xl text-white font-semibold flex items-center justify-center focus-ring"
          >
            {isLoading ? (
              <>
        ...
        <div className="mt-8">
          ...
          <div className="mt-6">
            <button className="btn-secondary w-full py-4 px-6 rounded-xl flex items-center justify-center focus-ring group">
